...
class GlobalLocalAttention(nn.Module):
    def __init__(
        ...
        self.attn_x = nn.AvgPool2d(
            kernel_size=(window_size, 1), stride=1, padding=(window_size // 2, 0)
        )
        self.attn_y = nn.AvgPool2d(
            kernel_size=(1, window_size), stride=1, padding=(0, window_size // 2)
        )
...
class UNetSatDecoder(nn.Module):
    def __init__(
        self,
        ...
        super(UNetSatDecoder, self).__init__()
